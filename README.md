...
Frontend - HTML, CSS, JavaScript (modular), Leaflet (hărți)

Backend - PHP (API REST), MySQL (persistență date)

Algoritmică și procesare date - Python, OSMnx (generare graf rutier), NetworkX (algoritmi pe graf)

Date - OpenStreetMap, GTFS (transport public Brașov)
...
Proiectul include teste funcționale pentru: validări frontend, algoritm A*, euristică, rutare multimodală, fallback OSRM
